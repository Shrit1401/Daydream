...
export default function Login() {
  ...
  const handleGoogleSignIn = async () => {
    setLoading(true);
    try {
      Alert.alert('Info', 'Google sign-in requires Expo AuthSession implementation');
    } catch (error: unknown) {
  ...
  return (
    <Container>
      <View className="w-full flex-1 items-center justify-center px-8">
        <InstrumentText className="mb-10 text-[60px] text-black">Login</InstrumentText>
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            resizeMode="contain"
          />
          <Text className="ml-2 font-semibold text-gray-700">Sign in with Google</Text>
        </TouchableOpacity>
